            ...
            <Navbar className="navbar" id="footer">   
                    ...
                    <div className="col pl-0 text-align-left">
                        ...
                        <Navbar.Collapse className="justify-content-around">
                            <Nav.Link className="navbar-link" href="#">Privacy Policy</Nav.Link>
                            <Nav.Link className="navbar-link" href="#">Terms & Conditions</Nav.Link>
                            <small>Copyright © Accenture UK</small>
                        </Navbar.Collapse>
                    </div>
